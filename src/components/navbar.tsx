        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden md:flex">
              <div className="bg-card backdrop-blur-sm border border rounded-full px-6 py-2">
                <div className="flex items-center space-x-8">
                  <a href="/" className="text-sm font-medium text-foreground flex items-center">
                  ...
                  <a href="/case-studies" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                    Case Studies
                  </a>
                </div>
              </div>
            ...
            {/* Actions */}
            <div className="bg-card backdrop-blur-sm border rounded-full px-4 py-2">
