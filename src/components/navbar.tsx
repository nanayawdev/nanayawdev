        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <ThemeToggle />
              <motion.button
                className="bg-foreground text-background px-5 py-2.5 rounded-full text-sm font-semibold cursor-pointer"
            ...
            <div className="lg:hidden flex items-center gap-2">
              <motion.button
                className="bg-foreground text-background px-4 py-2 rounded-full text-sm font-semibold cursor-pointer"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                onClick={() => setIsModalOpen(true)}
              >
            ...
            >
              <div className="max-w-7xl mx-auto px-6 py-4 space-y-1">
                ...
                <div className="pt-3 pb-1 flex items-center justify-between gap-3">
                  <button
                    className="flex-1 bg-foreground text-background py-3 rounded-xl text-sm font-semibold cursor-pointer"
