        ...
        <div className="relative z-20 flex flex-col justify-between h-full">
          ...
          <Link href="/">
            <div className="w-10 h-10 rounded-lg overflow-hidden">
              <Image src="/logo.png" alt="Luminix Studio" width={40} height={40} className="w-full h-full object-contain" />
            </div>
          </Link>
        ...
        <div className="lg:hidden px-8 pt-8 pb-4">
          <Link href="/">
            <div className="w-9 h-9 rounded-lg overflow-hidden">
              <Image src="/logo.png" alt="Luminix Studio" width={36} height={36} className="w-full h-full object-contain" />
            </div>
          </Link>
        </div>
